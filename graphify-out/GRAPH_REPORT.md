...
## Corpus Check
- 92 files · ~57,127 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1385 nodes · 3372 edges · 51 communities (34 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 80 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `35dcce23`
...
Cohesion: 0.06
Nodes (52): GiggsError, Leaf, lineage_walks_history(), Mesh, Plot, plots_are_content_addressed(), replication_roundtrip(), Error (+44 more)

### Community 1 - "Hyphae DHT Behaviour"
Cohesion: 0.06
Nodes (52): Behaviour, addr_family_rank(), deterministic_seed_yields_deterministic_peer_id(), dht_local_store_roundtrip_via_put(), HyphaeConfig, HyphaeError, HyphaeNode, HyphaEvent (+44 more)

### Community 2 - "Layer Archive Stack"
Cohesion: 0.08
Nodes (46): Child, Command, archive_stacks_on_rootfs(), LayerArchive, LayerStore, AsRef, HashMap, Into (+38 more)

### Community 3 - "Node Control Plane"
Cohesion: 0.06
Nodes (93): Box, candidate_cmd(), CandidateCmd, chamber_serve(), Cli, Commands, daemon(), deploy() (+85 more)
...
Cohesion: 0.06
Nodes (54): build_sh_produces_dist_artifact(), collect_artifact(), execute(), Flywheel, InertiaError, materialize_leaves(), Momentum, Error (+46 more)

### Community 6 - "Isotope Atom Gossip"
Cohesion: 0.14
Nodes (18): absorb_accepts_foreign_shard_for_gossip(), Atom, for_node_is_stable(), IsotopeError, key_for_shard(), keys_route_to_their_natural_shard(), last_writer_wins_on_fuse(), migrate_preserves_atoms() (+10 more)
...
Cohesion: 0.06
Nodes (37): detect_global_ipv6(), diagnose_membrane(), env_assume_reachable(), FruitingBody, Resources, Option, Vitality, cannot_inject_duplicate_ion() (+29 more)
...
Cohesion: 0.07
Nodes (70): announce_and_discover_session(), announce_session(), announcement_is_kind_39401(), backchannel_event_is_kind_39406(), BackchannelMessage, build_backchannel_event(), CandidatePeer, CandidateRelay (+62 more)
...
### Community 44 - "nostr-transport-smoke.sh"
Cohesion: 0.83
Nodes (3): cleanup(), die(), nostr-transport-smoke.sh script

### Community 45 - "volunteer-pipeline.sh"
Cohesion: 0.33
Nodes (15): cmd_cgnat_check(), cmd_folha_attach(), cmd_mark(), cmd_next(), cmd_onboard(), cmd_pitch(), cmd_prep_listen(), cmd_probe() (+7 more)
...
### Community 53 - "Result"
Cohesion: 0.14
Nodes (10): ParseResourcesError, Error, Result, S, Self, String, D, Err (+2 more)
...
- **Why does `Organism` connect `Giggs Mesh Leaves` to `Hyphae DHT Behaviour`, `Layer Archive Stack`, `Node Control Plane`, `Membrane Listen Addrs`, `Serde Trait Impls`, `Isotope Atom Gossip`, `Node Store Ions`, `Pheromone Alarms`, `Vacuum Chamber Cloud`, `CLI Daemon Commands`, `Mailbox Store Forward`?**
  _High betweenness centrality (0.263) - this node is a cross-community bridge._
- **Why does `HyphaeNode` connect `Hyphae DHT Behaviour` to `Giggs Mesh Leaves`, `Relay Mesh Ads`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `ContentId` connect `Giggs Mesh Leaves` to `Layer Archive Stack`, `Serde Trait Impls`, `proxy.rs`, `Vacuum Chamber Cloud`, `Mailbox Store Forward`, `Result`?**
...
- **Should `Hyphae DHT Behaviour` be split into smaller, more focused modules?**
  _Cohesion score 0.06074561403508772 - nodes in this community are weakly interconnected._
